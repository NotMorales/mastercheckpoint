        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    {{$experiencia->nombreExperiencia}} </h3>
                    ...
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="{{route('misEstudiantes', ['experiencia' => $experiencia->experienciaEducativaId])}}">
                                    Estudiantes
                                </a>
                            </h3>
            ...
            <div class="kt-portlet kt-iconbox kt-iconbox--warning kt-iconbox--animate-fast">
                <div class="kt-portlet__body">
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="{{route('misPaseLista', ['experiencia' => $experiencia->experienciaEducativaId])}}">
                                    Pase de Lista
                                </a>
                            </h3>
                            <div class="kt-iconbox__content">
            ...
            <div class="kt-portlet kt-iconbox kt-iconbox--primary kt-iconbox--animate-fast">
                <div class="kt-portlet__body">
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="{{route('verParticipaciones', ['experiencia' => $experiencia->experienciaEducativaId])}}">
                                    Participaciones
                                </a>
                            </h3>
                            <div class="kt-iconbox__content">
            ...
            <div class="kt-portlet kt-iconbox kt-iconbox--info kt-iconbox--animate-fast">
                <div class="kt-portlet__body">
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="{{route('misTemas', ['experiencia' => $experiencia->experienciaEducativaId])}}">
                                    Temas
                                </a>
                            </h3>
                            <div class="kt-iconbox__content">
