                    ...
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="{{route('salonEst', ['experiencia' => $experiencia->experienciaEducativaId])}}">
                                    Salon de clases
                                </a>
                            </h3>
            ...
            <div class="kt-portlet kt-iconbox kt-iconbox--animate-fast">
                <div class="kt-portlet__body">
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="{{route('paseListaEst', ['experiencia' => $experiencia->experienciaEducativaId])}}">
                                    Pase de Lista
                                </a>
                            </h3>
                            <div class="kt-iconbox__content">
            ...
            <div class="kt-portlet kt-iconbox kt-iconbox--animate-fast">
                <div class="kt-portlet__body">
                    <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                            <h3 class="kt-iconbox__title">
                                <a class="kt-link" href="{{route('verParticipacionesEst', ['experiencia' => $experiencia->experienciaEducativaId])}}">
                                    Participaciones
                                </a>
                            </h3>
                            <div class="kt-iconbox__content">
